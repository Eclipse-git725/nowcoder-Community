...
public class DiscussPostController implements CommunityConstant {
    ...
    public String getDiscussPost(@PathVariable("discussPostId")int discussPostId, Model model, Page page) {
        ...
        // 回复：给评论的评论
        // 评论列表
        List<Comment> commentList = commentService.findComments(ENTITY_TYPE_POST, post.getId(), page.getOffset(), page.getLimit());
        // 评论VO列表
        ...
        if(commentList != null) {
            for(Comment comment : commentList) {
                ...
                // 作者
                User comment_user = userService.findUserById(comment.getUserId());
                commentVo.put("user", comment_user);
